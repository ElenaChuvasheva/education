...
@extend_schema_view(
    list=extend_schema(operation_id='Список модулей',
                       description='Получение списка модулей'),
    create=extend_schema(operation_id='Создание модуля',
                         description='Создание модуля'),
    retrieve=extend_schema(operation_id='Получение модуля',
                       description='Получение информации о выбранном модуле'),
    update=extend_schema(operation_id='Изменение модуля',
                       description='Перезапись всех полей модуля'),
    partial_update=extend_schema(operation_id='Частичное изменение модуля',
                       description='Перезапись выбранных полей модуля'),
    destroy=extend_schema(operation_id='Удаление выбранного модуля',
